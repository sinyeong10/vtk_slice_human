...
plane_reader.SetFileName("output_image.vti")  # Specify the path to the saved .vtp file
plane_reader.Update()
...
jpg_writer.SetFileName("output_image.jpg")  # Specify the path and filename for the saved jpg file
